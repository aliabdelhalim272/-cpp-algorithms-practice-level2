...
// Purpose: Counts how many negative numbers exist in an array.
int CountTheNegativeNumbers(int arr[100],int arrLength)
{
        int Counter=0;
        for(int i=0;i<arrLength;i++)
        {
...
int main()
{
        ...
        cout<<CountTheNegativeNumbers(arr,arrLength)<<endl;
        return 0;
}